...
import song1 from './Audio/Champagne.mp3';
import song2 from './Audio/Dekhya_Kite.mp3';
import song3 from './Audio/Kinni_Kinni.mp3';
import song4 from './Audio/Softly.mp3';

// Define an object containing different lists of items
const ArrayList = {
        // List of menus
    Menu: [
                // Each menu item contains parent index, name, and icon
    ...
    Songs: [
        {
            ...
            source: song1,
            duration: 28,
            icon: "https://c.saavncdn.com/209/MoonChild-Era-Punjabi-2021-20230915040616-500x500.jpg",
        },
        {
            parentIndex: 4,
            name: "Dekhya Kite",
            source: song2,
            duration: 31,
            icon: "https://c.saavncdn.com/961/Dekhya-Kite-Punjabi-2022-20221007161351-500x500.jpg"
        },
        {
            parentIndex: 4,
            name: "Kinni Kinni",
            source: song3,
            duration: 30,
            icon: "https://c.saavncdn.com/276/Ghost-English-2023-20231028142825-500x500.jpg"
        },
        {
            parentIndex: 4,
            name: "Softly",
            source: song4,
            duration: 30,
            icon: "https://c.saavncdn.com/538/Making-Memories-English-2023-20230818075015-500x500.jpg"
        },
    ],
    Album: [
        {
